...
internal class GingerbreadFurnitureSolutionLoader : FurnitureSolutionLoaderBase
{
    public override void AddSolution(Mod mod, Mod furnitureSolutionMod)
    {
        ...
        {
            SolidTileType = GetTileType("GingerbreadBlockNew"),
            WallType = thoriumMod.Find<ModWall>("GingerbreadWall").Type,
            PlatformType = GetTileType("GingerbreadPlatform"),
            PlatformIndex = 0,
            ...
            DoorIndex = style,
            ChestType = GetTileType("GingerbreadChest"),
            ChestIndex = 0,
        ...
        int ingredientType = thoriumMod.Find<ModItem>("GingerbreadBlock").Type;
        ...
        var result = furnitureSolutionMod.Call(
            ...
            mod,
            "GingerbreadFurniture",
            "FurnitureSolutionExtensionExample/Content/Items/Ammo/ThoriumMod/GingerbreadFurnitureSolution",
            (int)DustID.Sandnado,
            setRecipeContent,
