...
internal class EvergreenWoodFurnitureSolutionLoader : FurnitureSolutionLoaderBase
{
    public override void AddSolution(Mod mod, Mod furnitureSolutionMod)
    {
        ...
        {
            SolidTileType = GetTileType("EvergreenBlock"),
            WallType = thoriumMod.Find<ModWall>("EvergreenWall").Type,
            PlatformType = GetTileType("EvergreenPlatform"),
            PlatformIndex = 0,
            ...
            DoorIndex = style,
            ChestType = GetTileType("EvergreenChest"),
            ChestIndex = 0,
        ...
        int ingredientType = thoriumMod.Find<ModItem>("EvergreenBlock").Type;
        ...
        var result = furnitureSolutionMod.Call(
            ...
            mod,
            "EvergreenWoodFurniture",
            "FurnitureSolutionExtensionExample/Content/Items/Ammo/ThoriumMod/EvergreenWoodFurnitureSolution",
            (int)DustID.GreenMoss,
            setRecipeContent,
