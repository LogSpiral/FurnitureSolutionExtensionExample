...
internal class FossilFurnitureSolutionLoader : FurnitureSolutionLoaderBase
{
    public override void AddSolution(Mod mod, Mod furnitureSolutionMod)
    {
        ...
        {
            SolidTileType = TileID.DesertFossil,
            WallType = WallID.DesertFossil,
            PlatformType = GetTileType("FossilPlatform"),
            PlatformIndex = 0,
            ...
            DoorIndex = style,
            ChestType = GetTileType("FossilChest"),
            ChestIndex = 0,
        ...
        int ingredientType = ItemID.DesertFossil;
        ...
        var result = furnitureSolutionMod.Call(
            ...
            mod,
            "FossilFurniture",
            "FurnitureSolutionExtensionExample/Content/Items/Ammo/ThoriumMod/FossilFurnitureSolution",
            (int)DustID.Sandstorm,
            setRecipeContent,
