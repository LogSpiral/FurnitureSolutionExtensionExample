...
internal class NagaFurnitureSolutionLoader : FurnitureSolutionLoaderBase
{
    public override void AddSolution(Mod mod, Mod furnitureSolutionMod)
    {
        ...
        {
            SolidTileType = GetTileType("NagaBlockNew"),
            WallType = thoriumMod.Find<ModWall>("NagaWall").Type,
            PlatformType = GetTileType("NagaPlatform"),
            PlatformIndex = 0,
            ...
            DoorIndex = style,
            ChestType = GetTileType("NagaChest"),
            ChestIndex = 0,
        ...
        int ingredientType = thoriumMod.Find<ModItem>("NagaBlock").Type;
        ...
        var result = furnitureSolutionMod.Call(
            ...
            mod,
            "NagaFurniture",
            "FurnitureSolutionExtensionExample/Content/Items/Ammo/ThoriumMod/NagaFurnitureSolution",
            (int)DustID.Firework_Green,
            setRecipeContent,
