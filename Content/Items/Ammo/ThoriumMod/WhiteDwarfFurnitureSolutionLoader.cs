...
internal class WhiteDwarfFurnitureSolutionLoader : FurnitureSolutionLoaderBase
{
    public override void AddSolution(Mod mod, Mod furnitureSolutionMod)
    {
        ...
        {
            SolidTileType = GetTileType("WhiteDwarfBrick"),
            WallType = thoriumMod.Find<ModWall>("WhiteDwarfBrickWall").Type,
            PlatformType = GetTileType("WhiteDwarfPlatform"),
            PlatformIndex = 0,
            ...
            DoorIndex = style,
            ChestType = GetTileType("WhiteDwarfChest"),
            ChestIndex = 0,
        ...
        int ingredientType = thoriumMod.Find<ModItem>("WhiteDwarfBrick").Type;
        ...
        var result = furnitureSolutionMod.Call(
            ...
            mod,
            "WhiteDwarfFurniture",
            "FurnitureSolutionExtensionExample/Content/Items/Ammo/ThoriumMod/WhiteDwarfFurnitureSolution",
            (int)DustID.Plantera_Green,
            setRecipeContent,
