...
internal class LivingMahoganyFurnitureSolutionLoader : FurnitureSolutionLoaderBase
{
    public override void AddSolution(Mod mod, Mod furnitureSolutionMod)
    {
        ...
        {
            SolidTileType = TileID.LivingMahogany,
            WallType = thoriumMod.Find<ModWall>("LivingMahoganyWall").Type,
            PlatformType = GetTileType("LivingMahoganyPlatform"),
            PlatformIndex = 0,
            ...
            DoorIndex = style,
            ChestType = GetTileType("LivingMahoganyChest"),
            ChestIndex = 0,
        ...
        int ingredientType = ItemID.RichMahogany;
        ...
        var result = furnitureSolutionMod.Call(
            ...
            mod,
            "LivingMahoganyFurniture",
            "FurnitureSolutionExtensionExample/Content/Items/Ammo/ThoriumMod/LivingMahoganyFurnitureSolution",
            (int)DustID.RichMahogany,
            setRecipeContent,
