...
internal class LodestoneFurnitureSolutionLoader : FurnitureSolutionLoaderBase
{
    public override void AddSolution(Mod mod, Mod furnitureSolutionMod)
    {
        ...
        {
            SolidTileType = GetTileType("LodestoneSlab"),
            WallType = thoriumMod.Find<ModWall>("LodestoneSlabWall").Type,
            PlatformType = GetTileType("LodestonePlatform"),
            PlatformIndex = 0,
            ...
            DoorIndex = style,
            ChestType = GetTileType("LodestoneChest"),
            ChestIndex = 0,
        ...
        int ingredientType = thoriumMod.Find<ModItem>("LodestoneSlab").Type;
        ...
        var result = furnitureSolutionMod.Call(
            ...
            mod,
            "LodestoneFurniture",
            "FurnitureSolutionExtensionExample/Content/Items/Ammo/ThoriumMod/LodestoneFurnitureSolution",
