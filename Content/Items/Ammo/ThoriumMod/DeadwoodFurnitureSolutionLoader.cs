...
internal class DeadwoodFurnitureSolutionLoader : FurnitureSolutionLoaderBase
{
    public override void AddSolution(Mod mod, Mod furnitureSolutionMod)
    {
        ...
        {
            SolidTileType = GetTileType("Deadwood"),
            WallType = thoriumMod.Find<ModWall>("DeadwoodWall").Type,
            PlatformType = GetTileType("DeadwoodPlatform"),
            PlatformIndex = 0,
            ...
            DoorIndex = style,
            ChestType = GetTileType("DeadwoodChest"),
            ChestIndex = 0,
        ...
        int ingredientType = thoriumMod.Find<ModItem>("Deadwood").Type;
        ...
        var result = furnitureSolutionMod.Call(
            ...
            mod,
            "DeadwoodFurniture",
            "FurnitureSolutionExtensionExample/Content/Items/Ammo/ThoriumMod/DeadwoodFurnitureSolution",
            (int)DustID.BubbleBurst_White,
            setRecipeContent,
