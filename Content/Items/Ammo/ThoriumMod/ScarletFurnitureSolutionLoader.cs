...
internal class ScarletFurnitureSolutionLoader : FurnitureSolutionLoaderBase
{
    public override void AddSolution(Mod mod, Mod furnitureSolutionMod)
    {
        ...
        {
            SolidTileType = GetTileType("ScarletChestPlatform"),
            WallType = thoriumMod.Find<ModWall>("ScarletWall").Type,
            PlatformType = GetTileType("ScarletPlatform"),
            PlatformIndex = 0,
            ...
            DoorIndex = style,
            ChestType = GetTileType("ScarletChest"),
            ChestIndex = 0,
        ...
        int ingredientType = thoriumMod.Find<ModItem>("ScarletBlock").Type;
        ...
        var result = furnitureSolutionMod.Call(
            ...
            mod,
            "ScarletFurniture",
            "FurnitureSolutionExtensionExample/Content/Items/Ammo/ThoriumMod/ScarletFurnitureSolution",
            (int)DustID.RedMoss,
            setRecipeContent,
