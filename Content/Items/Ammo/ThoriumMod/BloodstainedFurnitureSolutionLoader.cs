...
internal class BloodstainedFurnitureSolutionLoader : FurnitureSolutionLoaderBase
{
    public override void AddSolution(Mod mod, Mod furnitureSolutionMod)
    {
        ...
        {
            SolidTileType = GetTileType("BloodstainedBlock"),
            WallType = thoriumMod.Find<ModWall>("BloodstainedWall").Type,
            PlatformType = GetTileType("BloodstainedPlatform"),
            PlatformIndex = 0,
            ...
            DoorIndex = style,
            ChestType = GetTileType("BloodstainedChest"),
            ChestIndex = 0,
        ...
        int ingredientType = thoriumMod.Find<ModItem>("BloodstainedBlock").Type;
        ...
        var result = furnitureSolutionMod.Call(
            ...
            mod,
            "BloodstainedFurniture",
            "FurnitureSolutionExtensionExample/Content/Items/Ammo/ThoriumMod/BloodstainedFurnitureSolution",
            (int)DustID.RedMoss,
            setRecipeContent,
