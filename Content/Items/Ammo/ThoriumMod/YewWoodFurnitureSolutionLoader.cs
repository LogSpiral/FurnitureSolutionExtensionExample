...
internal class YewWoodFurnitureSolutionLoader : FurnitureSolutionLoaderBase
{
    public override void AddSolution(Mod mod, Mod furnitureSolutionMod)
    {
        ...
        {
            SolidTileType = GetTileType("YewWood"),
            WallType = thoriumMod.Find<ModWall>("YewWoodWall").Type,
            PlatformType = GetTileType("YewPlatform"),
            PlatformIndex = 0,
            ...
            DoorIndex = style,
            ChestType = GetTileType("YewChest"),
            ChestIndex = 0,
        ...
        int ingredientType = thoriumMod.Find<ModItem>("YewWood").Type;
        ...
        var result = furnitureSolutionMod.Call(
            ...
            mod,
            "YewWoodFurniture",
            "FurnitureSolutionExtensionExample/Content/Items/Ammo/ThoriumMod/YewWoodFurnitureSolution",
            (int)DustID.BorealWood,
            setRecipeContent,
