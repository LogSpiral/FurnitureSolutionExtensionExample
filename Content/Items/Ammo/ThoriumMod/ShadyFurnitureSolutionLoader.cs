...
internal class ShadyFurnitureSolutionLoader : FurnitureSolutionLoaderBase
{
    public override void AddSolution(Mod mod, Mod furnitureSolutionMod)
    {
        ...
        {
            SolidTileType = GetTileType("ShadyBlock"),
            WallType = thoriumMod.Find<ModWall>("ShadyWall").Type,
            PlatformType = GetTileType("ShadyPlatform"),
            PlatformIndex = 0,
            ...
            DoorIndex = style,
            ChestType = GetTileType("ShadyChest"),
            ChestIndex = 0,
        ...
        int ingredientType = thoriumMod.Find<ModItem>("ShadyBlock").Type;
        ...
        var result = furnitureSolutionMod.Call(
            ...
            mod,
            "ShadyFurniture",
            "FurnitureSolutionExtensionExample/Content/Items/Ammo/ThoriumMod/ShadyFurnitureSolution",
            (int)DustID.PurpleMoss,
            setRecipeContent,
