...
internal class MarineFurnitureSolutionLoader : FurnitureSolutionLoaderBase
{
    public override void AddSolution(Mod mod, Mod furnitureSolutionMod)
    {
        ...
        {
            SolidTileType = GetTileType("RefinedMarineBlock"),
            WallType = thoriumMod.Find<ModWall>("RefinedMarineWall").Type,
            PlatformType = GetTileType("MarinePlatform"),
            PlatformIndex = 0,
            ...
            DoorIndex = style,
            ChestType = GetTileType("MarineChest"),
            ChestIndex = 0,
        ...
        int ingredientType = thoriumMod.Find<ModItem>("RefinedMarineBlock").Type;
        ...
        var result = furnitureSolutionMod.Call(
            ...
            mod,
            "MarineFurniture",
            "FurnitureSolutionExtensionExample/Content/Items/Ammo/ThoriumMod/MarineFurnitureSolution",
            (int)DustID.BlueFairy,
            setRecipeContent,
